<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="~/wFrmColores.aspx.cs" Inherits="Proyecto.wFrmColores" %>
        ...
        <div class="shop-grid">
            <div class="container">
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    ...
                    <div class="img"><video src="Videos/Colores.mp4#t=17" autoplay="autoplay" loop="loop" preload="auto" width="720" height="450" muted="muted" ></video></div>
                            <div class="info">
                                <div class="pull-right styl-hdn">
                                    <h3>En el video se muestran los colores: <h2>Morado</h2><h2>Rosado</h2><h2>Verde</h2><h2>Amarillo</h2><h2>Anaranjado</h2></h3>
                                </div>
                                <div class="clearfix"></div>
                            </div></div>
                        </div>
