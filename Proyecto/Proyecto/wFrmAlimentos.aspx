<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="~/wFrmAlimentos.aspx.designer.cs" Inherits="Proyecto.wFrmAlimentos" %>
        ...
        <div class="shop-grid">
            <div class="container">
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    ...
                    <div class="img"><video src="Videos/Alimentos.mp4#t=9" autoplay="autoplay" loop="loop" preload="auto" width="720" height="450" muted="muted" ></video></div>
                            <div class="info">
                                <div class="pull-right styl-hdn">
                                    <h3>En el video se muestran algunas señas de alimentos <h2>Frutas</h2><h2>Arroz</h2><h2>Frijoles</h2><h2>Fresco</h2></h3>
                                </div>
                                <div class="clearfix"></div>
                            </div></div>
                        </div>
