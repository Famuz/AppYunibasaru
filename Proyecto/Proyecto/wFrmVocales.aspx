<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="~/wFrmVocales.aspx.designer.cs" Inherits="Proyecto.wFrmVocales" %>
        ...
        <div class="shop-grid">
            <div class="container">
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    ...
                    <div class="img"><video src="Videos/Vocales.mp4" autoplay="autoplay" loop="loop" preload="auto" width="720" height="450" muted="muted" ></video></div>
                            <div class="info">
                                <div class="pull-left styl-hdn">
                                    <h3>En el video se muestran las vocales <h2>A E I O U</h2></h3>
                                </div>
                                <div class="clearfix"></div>
                            </div></div>
                        </div>
