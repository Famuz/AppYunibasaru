<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="~/wFrnInicio.aspx.designer.cs" Inherits="Proyecto.Formulario_web1" %>
        ...
        <div class="shop-grid">
            <div class="container">
                <div class="col-md-4 grid-stn simpleCart_shelfItem">
                    ...
                    <div class="img"><video src="Videos/Bienvenidos.mp4" autoplay="autoplay" loop="loop" preload="auto" width="720" height="450" muted="muted" ></video></div>
                            <div class="info">
                                <div class="pull-right styl-hdn">
                                    <h3>En el video las señas que se muestran significan: <h2>Bienvenidos a Yunibasaru</h2></h3>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            </div>
